...
class MSMT17(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, pid_begin=0, **kwargs):
        ...
        self.list_val_path = os.listdir(self.test_dir)
        self.list_query_path =os.listdir(self.test_dir)
        self.list_gallery_path =os.listdir(self.test_dir)
